...
class App extends $HelperTrait {
  ...
  REDIS_USED = super.isValidVal(super.getEnvApp("REDIS_USED"), "equal", "true");
  ...
  APP_SERVER() {
    ...
    return super.isValidVal(APP_ENV, "equal", "development") ? `http://localhost:${APP_PORT}` : `https://${APP_DOMAIN}:${APP_PORT}`;
  }
